...
- 증거 경로: C:\Code\Boothy\tests\hardware\capture-source\run-20260813-115426-hv14\session-evidence\diagnostics\source-comparison.jsonl
- 전체 표본 행: 105
...
**PASS (telemetry completeness only)** — source-comparison 행의 완결성 조건을 만족합니다.

> 이것은 HV-14 Go가 아닙니다. capability, correlation, quality, aggregate, decision 증거가 아직 필요합니다.
