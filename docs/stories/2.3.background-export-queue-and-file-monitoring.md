...
- [ ] Task 7: Tests + validation scenarios (AC: 1-8)
  ...
  - [ ] Manual: verify background export completion state persists across app restart (metadata).
    [Source: docs/architecture/data-models-and-schema-changes.md#boothysession-folder-backed-session]
  - [ ] Manual: verify manual export retries any photos with background export failures.
    [Source: docs/prd-session-timeline-smart-export.md#story-23-background-export-queue--file-monitoring]
  - [ ] Manual: verify session change/reset stops or flushes the background queue and does not process stale items.
    [Source: docs/prd-session-timeline-smart-export.md#story-23-background-export-queue--file-monitoring]
  - [ ] Manual: verify duplicate file-watcher events do not trigger duplicate exports for the same photo.
    [Source: docs/prd-session-timeline-smart-export.md#story-23-background-export-queue--file-monitoring]
