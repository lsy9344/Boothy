...
3. Hunt for missed edge cases, state machine gaps, stale-data paths, race conditions, disabled-user-action traps, partial-failure handling issues, and test gaps.
