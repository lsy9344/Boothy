...
use crate::image_processing::{
    ...
    apply_flip, apply_rotation, auto_results_to_json, get_all_adjustments_from_json,
...
pub fn generate_thumbnail_data(
    ...
    let composite_image = if let Some(img) = preloaded_image {
        image_loader::composite_patches_on_image(img.clone(), &adjustments)?
    } else {
